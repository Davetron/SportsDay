				...
				<g:each in="${eventInstanceList}" status="i" var="eventInstance">
					<div id="event${eventInstance.id}" class="eventPanel">
						...
						<div class="row-fluid">
							<div id="headerbar" class="span12">
								<h3>
									${eventInstance.name} (<g:formatDate format="E HH:mm" date="${eventInstance.time}" />) 
									<a href="#myModal" role="button" class="btn btn-large btn-primary" data-toggle="modal">Select Event</a>
								</h3>
							</div>
