	...
	<body>
		...
		<div id="show-athlete" class="content scaffold-show" role="main">
			...
			<ol class="property-list athlete">
				...
				<g:if test="${athleteInstance?.country}">
				<li class="fieldcontain">
					<span id="country-label" class="property-label"><g:message code="athlete.country.label" default="Country" /></span>
					
						<span class="property-value" aria-labelledby="country-label"><g:link controller="country" action="show" id="${athleteInstance?.country?.id}">${athleteInstance?.country?.encodeAsHTML()}</g:link></span>
			...
			<g:form>
				<fieldset class="buttons">
					<g:hiddenField name="id" value="${athleteInstance?.id}" />
					<g:link class="edit" action="edit" id="${athleteInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
